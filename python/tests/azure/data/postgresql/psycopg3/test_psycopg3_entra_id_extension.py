...
class TestSyncConnection:
    ...
    def test_connect_with_entra_credential(self):
        ...
        with patch(
            "azurepg_entra.psycopg3.entra_connection.get_entra_conninfo",
    ...
    def test_connect_invalid_credential_type_throws(self):
        ...
        with pytest.raises(
            ...
            match="credential must be a TokenCredential for sync connections",
        ):
...
class TestAsyncConnection:
    ...
    async def test_connect_with_entra_credential(self):
        ...
        with patch(
            "azurepg_entra.psycopg3.async_entra_connection.get_entra_conninfo_async",
    ...
    async def test_connect_invalid_credential_type_throws(self):
        ...
        with pytest.raises(
            CredentialValueError,
            match="credential must be an AsyncTokenCredential for async connections",
        ):
