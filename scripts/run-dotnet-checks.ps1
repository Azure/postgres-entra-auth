...
try {
    ...
    foreach ($version in $DotNetVersions) {
        ...
        dotnet test "tests\Azure\Data\Postgresql\Npgsql\Azure.Data.Postgresql.Npgsql.Tests.csproj" --no-build --configuration $Configuration --logger trx --results-directory "TestResults"
